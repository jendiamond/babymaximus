...
class SleepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sleep" do
    assert_difference('Sleep.count') do
      post sleeps_url, params: { sleep: { day_id: @sleep.day_id, notes: @sleep.notes, sleep_end: @sleep.sleep_end, sleep_start: @sleep.sleep_start } }
    end
  ...
  test "should update sleep" do
    patch sleep_url(@sleep), params: { sleep: { day_id: @sleep.day_id, notes: @sleep.notes, sleep_end: @sleep.sleep_end, sleep_start: @sleep.sleep_start } }
